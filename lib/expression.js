...
define(["require", "exports", "khepri_ast/node"], (function(require, exports, __o) {
    "use strict";
    var Expression, ThisExpression, UnaryExpression, BinaryExpression, AssignmentExpression, LogicalExpression, ConditionalExpression, NewExpression, CallExpression, MemberExpression, FunctionExpression, ArrayExpression, ObjectExpression, LetExpression;
    var __o = __o,
        ...
        Node = __o["Node"]; {
            ...
            (AssignmentExpression = defineNode(Expression, "AssignmentExpression", ["left", "right"], (function(loc, operator, left, right) {
                Node.call(this, loc);
                (this.operator = operator);
                (this.left = left);
                (this.right = right);
            })));
            (LogicalExpression = defineNode(Expression, "LogicalExpression", ["left", "right"], (function(loc, operator, left, right) {
                Node.call(this, loc);
                (this.operator = operator);
                (this.left = left);
                (this.right = right);
